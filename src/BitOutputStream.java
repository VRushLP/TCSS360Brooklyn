 ...
 * individual bits to a file in a compact form. One minor limitation of this approach is that
 * the resulting file will always have a number of bits that is a multiple of 8. In effect,
 * whatever bits are output to the file are padded at the end with 0s to make the total number
