...
public class JobTest
{
    ...
    /**
     * This test asserts that the maximum number of volunteers is
     * greater than 0.
     */
    @Test
    ...
    /**
     * This test asserts that the toString method does not return
     * an empty string.
     */
    @Test
    ...
    public void testStartDate()
    {
        ...
        // Get the difference between start date and current date in milliseconds
    ...
    /**
     * This test asserts that the startDate is not more than 90 days
     * from today's date. This satisfies business rule #5 (see official requirements).
     */
    @Test
    ...
    /**
     * This test asserts that the endDate is not more than 90 days
     * from today's date. This satisfies business rule #5 (see official requirements).
     */
    @Test
    ...
    /**
     * This test asserts that the end date is no more than
     * two days after the start date.
     * This satisfies business rule #4 (see official requirements).
     */
    @Test
